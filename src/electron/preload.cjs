...
const api = {
  ...
  getConversationHistory: () => ipcRenderer.invoke("history:list"),
  saveConversationHistory: (conversation) => ipcRenderer.invoke("history:save", { conversation }),
  renameConversationHistory: (id, title) => ipcRenderer.invoke("history:rename", { id, title }),
  deleteConversationHistory: (id) => ipcRenderer.invoke("history:delete", { id }),
  getCommandCatalog: () => ipcRenderer.invoke("command:catalog"),
  executeCommand: (input, context) => ipcRenderer.invoke("command:execute", { input, context }),
