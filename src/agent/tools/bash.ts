...
export const bash: CoreTool = tool({
  description: 'Execute a shell command in the workspace. Add --timeout <ms> at the END of your command for long-running processes (max 90000ms). This operation may require user approval. If rejected, do not retry the same command during the current turn; ask for clarification or stop.',
  parameters: z.object({
